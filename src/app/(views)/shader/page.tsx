...
import galaxyVertexShader from './_glsl/vertex.glsl';
import galaxyFragmentShader from './_glsl/fragment.glsl';
...
const Skill = (): JSX.Element => {
  ...
  useEffect(() => {
    ...
    if (canvasIns.current) {
      ...
      camera.current = new PerspectiveCamera(75, width / height, 0.1, 100);
